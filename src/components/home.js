...
export default function Home() {
  return (
    <div>
      ...
      <p>Please checkout <LinkContainer to="/about"><button type="button" className="btn btn-link btn-link-de-chonk">About</button></LinkContainer> for more information about me, and <LinkContainer to="/game"><button type="button" className="btn btn-link btn-link-de-chonk">Game</button></LinkContainer> for a space game that I made. And finally, the source for this application is available on my <a target="_blank" rel="noreferrer" href={GitHub}>GitHub's</a> main page.</p>
    </div>
  );
}