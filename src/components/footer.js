  ...
  return (
    <footer id="application-footer" className="mx-auto">
      <dl className="row">
        ...
        <dd className="col"><a target="_blank" rel="noreferrer" href="https://github.com/HumbleHominid">HumbleHominid</a></dd>
        <div className="w-100"></div>
        <dt className="col text-right">LinkedIn</dt>
        <dd className="col"><a target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/michael-fryer-bb017013a/">Michael Fryer</a></dd>
        <div className="w-100"></div>
